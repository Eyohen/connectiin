      ...
      <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center p-12">
        ...
        <div className="relative max-w-md">
          ...
          <p className="text-gray-400 text-lg leading-relaxed">
            Find qualified partners, service providers, investors, and collaborators — all in one place.
          </p>
          ...
          <div className="mt-12 space-y-4">
            {[
              ...
              'Opportunity board & collaboration tools',
            ].map((feature) => (
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full py-3 bg-accent hover:bg-accent-dark text-white font-semibold rounded-lg transition-colors mt-2"
            >
              Create Account
            </button>
          </form>
          ...
          <div className="flex gap-3">
            <button className="flex-1 flex items-center justify-center gap-2 py-3 bg-navy-800 border border-white/10 rounded-lg text-gray-300 hover:border-white/20 hover:text-white transition-all">
